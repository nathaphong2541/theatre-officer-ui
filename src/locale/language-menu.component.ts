  ...
  <div class="relative inline-block text-left">
    ...
    <div *ngIf="open()"
        ...
        <span class="flex items-center gap-2">
            ...
            <span i18n="@@flagTh">{{ thLabel }}</span> <!-- แสดงชื่อภาษา -->
        </span>
        ...
        <span class="flex items-center gap-2">
            ...
            <span i18n="@@flagEng">{{ enLabel }}</span> <!-- แสดงชื่อภาษา -->
        </span>
...
export class LanguageMenuComponent {
    ...
    currentLabel() {
        return this.ls.currentLocale() === 'en' ? this.enLabel : this.thLabel;
    }

    currentFlagSrc() {
        return this.ls.currentLocale() === 'en'
    ...
    toggle() {
        ...
        this.open.set(next);
        if (next) {
            // โฟกัสตัวเลือกที่เป็นภาษาปัจจุบัน
            queueMicrotask(() => {
                (this.isCurrent('th') ? this.thBtn : this.enBtn)?.nativeElement.focus();
            });
        }
    }
